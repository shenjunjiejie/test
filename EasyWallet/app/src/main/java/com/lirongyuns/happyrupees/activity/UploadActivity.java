...
public class UploadActivity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_lirongyun);
    ...
    public AppDownloadListener obtainDownloadListener() {
        return new AppDownloadListener() {
            ...
            public void downloadFail(String msg) {
                ...
                Toast.makeText(UploadActivity.this, ResUtils.getString(com.cretin.www.cretinautoupdatelibrary.R.string.apk_file_download_fail), Toast.LENGTH_SHORT).show();
            }
