...
import com.lirongyuns.happyrupees.bean.ContentBean;
...
import com.lirongyuns.happyrupees.utils.RxUtils;
...
//                LogUtil.e(e.getMessage());
        ...
        public void onFailure(int code, String msg) {
            Log.e("onFailure","error:"+code+","+msg);
        }
...
//                    LogUtil.e(message);
    ...
    {
        return getFormBody(new JsonCreator());
    }
     ...
     * @return 表单对象
     */
    public static FormBody getFormBody(JsonCreator creator) {
...
//            LogUtil.i(JsonFormat.formatJson(jsonString));
        ...
        //分段加密
        try {
            byte[] bytes = RSA.encryptByPublicKey(jsonString.getBytes(), RSA.PUBLICKEY);
...
//            Log.e("kmsg",encryptString);
     ...
     * @return 表单对象
     */
    public static String getDatas(JsonCreator creator) {
        String jsonString = creator.toString();
//        Log.e("kmsg",jsonString);
        if (creator.size()>0) {
//            LogUtil.i(JsonFormat.formatJson(jsonString));
...
//            Log.e("kmsg",encryptString);
    ...
    public static RequestBody getTextBody(String value) {
        ...
        //分段加密
        try {
            byte[] bytes = RSA.encryptByPublicKey(value.getBytes(), RSA.PUBLICKEY);
            encryptString = Base64.encodeToString(bytes, Base64.DEFAULT);
        } catch (Exception e) {
            e.printStackTrace();
        }
