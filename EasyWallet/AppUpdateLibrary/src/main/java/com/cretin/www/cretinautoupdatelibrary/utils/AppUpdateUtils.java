...
public class AppUpdateUtils {
     ...
     * @param info
     */
    public void download(DownloadInfo info, Context context) {
        checkInit();
        ...
        downloadUpdateApkFilePath = getAppLocalPath(info.getProdVersionName(), context);
    ...
    public void reDownload() {
        ...
        download(downloadInfo, mContext);
    }
    ...
    public void clearAllData(Context context) {
        ...
        //删除已经下载好的文件
        AppUtils.delAllFile(new File(AppUtils.getAppRootPath(context)));
    }
