...
public class AppUtils {
     ...
     * @return
     */
    public static String getAppLocalPath(String versionName, Context context) {
        // apk 保存名称
        String apkName = AppUtils.getAppName(AppUpdateUtils.getInstance().getContext());
        apkName = apkName.replaceAll(" ", "");
    ...
    public static String getAppRootPath(Context context) {
        ...
        return context.getExternalFilesDir(null).getAbsolutePath() + "/" + packageName + "/apks";
    }
